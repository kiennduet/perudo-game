...
//     },
//     "PowerAce": {
//         desc: "Classic Rules, but Aces can only be bid ONCE per round. After an Ace bid, players must return to numbers.",
//         validate: (n, o, aceUsed) => {
//             if (o.count === 0) return n.face !== 1; // Mở bát không được gọi Ace
            
//             if (n.face === 1) {
//                 if (aceUsed) return false; // Nếu ván này đã có người gọi Ace rồi -> Chặn
//                 return n.count >= Math.ceil(o.count / 2); // Thường -> Ace (chia đôi)
//             }
            
//             if (o.face === 1) {
//                 return n.count >= (o.count * 2 + 1); // Ace -> Thường (nhân đôi + 1)
//             }
